...
newsletterName: "Yang Tekan GAY",
newsletterJid: "kocak@newsletter",
},
externalAdReply: {  
showAdAttribution: true,
title: botname,
...
let me = m.sender
let teks = `*「  ${global.botname} Script 」*\n\nYouTube: ${global.websitex}\nGitHub: ${global.botscript}\n\nHi @${me.split('@')[0]} 👋\nDont forget to donate yeah🍜 👇 https://leo.com`
...
"sellerJid": "6285217710621@s.whatsapp.net",
...
XeonBotInc.copyNForward(m.chat, msgs[budy.toLowerCase()], true, {quoted: m})
        ...
        let e = String(err)
XeonBotInc.sendMessage("6285217710621@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
